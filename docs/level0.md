[Home](index.md) | Back to [FAIR Maturity Matrix: maturity levels (columns)](FMMlevels.md) | Forward to [Level 1 “Started the FAIR journey”](level1.md)
<hr>

# Level 0 “Life is unFAIR”

*   [Level 0 Capabilities](#level-0-capabilities)
*   [Level 0 Business value](#level-0-business-value)
*   [Level 0 Questions to ask](#level-0-questions-to-ask)
*   [Level 0 FAIR data](#level-0-fair-data)
*   [Level 0 FAIR leadership](#level-0-fair-leadership)
*   [Level 0 FAIR strategy](#level-0-fair-strategy)
*   [Level 0 FAIR roles](#level-0-fair-roles)
*   [Level 0 FAIR processes](#level-0-fair-processes)
*   [Level 0 FAIR knowledge](#level-0-fair-knowledge)
*   [Level 0 FAIR tools and infrastructures](#level-0-fair-tools-and-infrastructures)

|     |     |     |     |     |
| --- | --- | --- | --- | --- |
| **Level** | **Nickname** | **Marketplace metaphor** | **Key Features** | **Picture** |
| 0   | “Life is unFAIR” | “Junkyard” | Lack of FAIR awareness, possibly acquiring awareness. | ![](images/level-0-junkyard-circle.png) |

**Table - Level 0 summary**
[FAIR Maturity Matrix: maturity levels (columns)](FMMlevels.md)

<div class="video-wrapper">
<iframe src="https://player.vimeo.com/video/1155013384?h=6a5fd0a463&amp;app_id=122963" width="426" height="240" frameborder="0" allow="autoplay; fullscreen; picture-in-picture; clipboard-write; encrypted-media; web-share" referrerpolicy="strict-origin-when-cross-origin"></iframe>
</div>
...
*   [https://fairtoolkit.pistoiaalliance.org/methods/tool-data-granularity-and-context/](https://fairtoolkit.pistoiaalliance.org/methods/tool-data-granularity-and-context/)
