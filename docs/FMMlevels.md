...
| --- | --- | --- | --- | --- |
| **Level** | **Nickname** | **Marketplace metaphor** | **Key Features** | **Picture** |
| 1   | "Started the FAIR journey." | "Flea market" | FAIR Awareness started; first pilots for implementation may appear. | ![](images/level-1-fleamarket-circle.png) |
...
| 2   | "Getting FAIR" | "Street Market" | FAIR Pilots for implementation are in place | ![](images/level-2-street-market-circle.png) |
...
| --- | --- | --- | --- | --- |
| **Level** | **Nickname** | **Marketplace metaphor** | **Features** | **Picture** |
| 3   | "Pretty FAIR" | “Specialized Local Markets” | FAIR Transition to good and best practice | ![](images/level-3-local-market-circle.png) |
...
| --- | --- | --- | --- | --- |
| **Level** | **Nickname** | **Marketplace metaphor** | **Features** | **Picture** |
| 4   | "Really FAIR " | "Hyper Market" | FAIR Operational, best practice known at the time of writing. Internal organizational focus. Emerging cross-company focus. | ![](images/level-4-hypermarket-circle.png) |
...
| --- | --- | --- | --- | --- |
| **Level** | **Nickname** | **Marketplace metaphor** | **Features** | **Picture** |
| 5   | "FAIRest of them all" | "Digital Online Store" | Largely aspirational: while conceivable, it still needs practical realization.  Cross-organization standards and Interoperability. | ![](images/level-5-online-store-circle.png) |
