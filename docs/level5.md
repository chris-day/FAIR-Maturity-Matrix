[Home](index.md) | Back to [Level 4 “Really FAIR”](level4.md) | Forward to [Resources and lexicon](resources_lexicon.md)
<hr>

# Level 5 "FAIRest of them all"

*   [Level 5 Capabilities](#level-5-capabilities)
*   [Level 5 Business value](#level-5-business-value)
*   [Level 5 Questions to ask](#level-5-questions-to-ask)
*   [Level 5 FAIR data](#level-5-fair-data)
*   [Level 5 FAIR leadership](#level-5-fair-leadership)
*   [Level 5 FAIR strategy](#level-5-fair-strategy)
*   [Level 5 FAIR roles](#level-5-fair-roles)
*   [Level 5 FAIR processes](#level-5-fair-processes)
*   [Level 5 FAIR knowledge](#level-5-fair-knowledge)
*   [Level 5 FAIR tools and infrastructures](#level-5-fair-tools-and-infrastructures)

|     |     |     |     |     |
| --- | --- | --- | --- | --- |
| **Level** | **Nickname** | **Marketplace metaphor** | **Features** | **Picture** |
| 5   | "FAIRest of them all" | ""Digital Online Store" | It is aspirational and conceivable, but it still needs to be realized.  Evidence exists of cross-organization standards and Interoperability. | ![](images/level-5-online-store-circle.png) |

**Table level 5 summary**
[FAIR Maturity Matrix: maturity levels (columns)](FMMlevels.md)

<div class="video-wrapper">
<iframe src="https://player.vimeo.com/video/1155012633?h=9ac8013a3b&amp;app_id=122963" width="426" height="240" frameborder="0" allow="autoplay; fullscreen; picture-in-picture; clipboard-write; encrypted-media; web-share" referrerpolicy="strict-origin-when-cross-origin"></iframe> 
</div>
...
**Semantic Model Managemen**t: It manages semantic models and ontologies, including external and in-house ontologies/controlled terminologies.
...
*   i[dentifier services](https://peta-pico.github.io/tapas/tapas.html?api=peta-pico/dsw-nanopub-api&op=/find_gofair_qualified_things_x&param_searchterm=%20&param_type=https://w3id.org/fair/fip/terms/Identifier-service&autosubmit=on)
    
*   [Metadata-data-linking-schema](https://peta-pico.github.io/tapas/tapas.html?api=peta-pico/dsw-nanopub-api&op=/find_gofair_qualified_things_x&param_searchterm=%20&param_type=https://w3id.org/fair/fip/terms/Metadata-data-linking-schema&autosubmit=on)
    
*   [Metadata schemas](https://peta-pico.github.io/tapas/tapas.html?api=peta-pico/dsw-nanopub-api&op=/find_gofair_qualified_things_x&param_searchterm=%20&param_type=https://w3id.org/fair/fip/terms/Metadata-schema&autosubmit=on)
    
*   [Registries](https://peta-pico.github.io/tapas/tapas.html?api=peta-pico/dsw-nanopub-api&op=/find_gofair_qualified_things_x&param_searchterm=%20&param_type=https://w3id.org/fair/fip/terms/Registry&autosubmit=on)
...
*   [Communication protocols](https://w3id.org/fair/fip/terms/Communication-protocol)
    
*   [Authorization&AuthenticationServices](https://peta-pico.github.io/tapas/tapas.html?api=peta-pico/dsw-nanopub-api&op=/find_gofair_qualified_things_x&param_searchterm=%20&param_type=https://w3id.org/fair/fip/terms/Authentication-and-authorization-service&autosubmit=on)
    
*   [Metadata preservation policy](https://peta-pico.github.io/tapas/tapas.html?api=peta-pico/dsw-nanopub-api&op=/find_gofair_qualified_things_x&param_searchterm=%20&param_type=https://w3id.org/fair/fip/terms/Metadata-preservation-policy&autosubmit=on)
...
*   [Knowledge representation languages](https://w3id.org/fair/fip/terms/Knowledge-representation-language)
    
*   [Structured vocabularies](https://peta-pico.github.io/tapas/tapas.html?api=peta-pico/dsw-nanopub-api&op=/find_gofair_qualified_things_x&param_searchterm=%20&param_type=https://w3id.org/fair/fip/terms/Structured-vocabulary&autosubmit=on)
    
*   [Semantic Model](https://peta-pico.github.io/tapas/tapas.html?api=peta-pico/dsw-nanopub-api&op=/find_gofair_qualified_things_x&param_searchterm=%20&param_type=https://w3id.org/fair/fip/terms/Semantic-model&autosubmit=on)
...
*   [Data Usage License](https://peta-pico.github.io/tapas/tapas.html?api=peta-pico/dsw-nanopub-api&op=/find_gofair_qualified_things_x&param_searchterm=%20&param_type=https://w3id.org/fair/fip/terms/Data-usage-license&autosubmit=on)
