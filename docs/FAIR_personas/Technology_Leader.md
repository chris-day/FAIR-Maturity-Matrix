...
## 	Description of role 	Technology_Leader
...
##	FAIR persona related to 	Technology_Leader
|	FAIR persona related to  Technology_Leader	|
|	---	|
...
##	Persona tasks of	Technology_Leader
...
##  	Issues and latent gains for	Technology_Leader
###	Issue for 	Technology_Leader
Issues: Too many initiatives and not enough budget or resources.  Fragmented data landscape, poorly described data that are siloed, of poor quality, and not semantically connected based upon a complex IT systems landscape.  Business priorities dictate digital transformation to support data and AI intiatives but majority of budget is consumed by "business as usual" IT needs.. 		
###	Latent gains for	Technology_Leader
