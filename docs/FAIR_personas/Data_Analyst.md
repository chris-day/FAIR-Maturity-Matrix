...
## 	Description of role 	Data_Analyst	
...
##	FAIR persona related to 	Data_Analyst	
|	FAIR persona related to  Data_Analyst	|	
|	---	|	
|	[Advanced_Data_Analysis_and_Insights_Professional](https://pistoiaalliance.github.io/FAIRMaturityMatrix/FAIR_personas/Advanced_Data_Analysis_and_Insights_Professional)	|	
...
##  	Issues and latent gains for	Data_Analyst	
###	Issue for 	Data_Analyst	
Issues: In a non-FAIR environment, Data Analysts struggle to find and access data, lack trust in quality and provenance, face high integration effort across silos, work with poor documentation and traceability, and produce analytics that are hard to reuse, audit, or scale across the organisation. 			
