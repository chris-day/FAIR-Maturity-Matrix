...
## 	Description of role 	FAIR_Trainer
...
##  	Issues and latent gains for	FAIR_Trainer
###	Issue for 	FAIR_Trainer
 The lower the organisation FAIR maturity level, the higher the complexity of the role and the need to create awareness.
Lack of clarity and alignment in terms of needs and requirements from the organisations can be expected.
