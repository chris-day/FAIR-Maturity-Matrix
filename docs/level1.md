[Home](index.md) | Back to [Level 0 “Life is unFAIR”](level0.md) | Forward to [Level 2 “Getting FAIR”](level2.md)
<hr>

# Level 1 "Started the FAIR journey"

*   [Level 1 Capabilities](#level-1-capabilities)
*   [Level 1 Business value](#level-1-business-value)
*   [Level 1 Questions to ask](#level-1-questions-to-ask)
*   [Level 1 FAIR data](#level-1-fair-data)
*   [Level 1 FAIR leadership](#level-1-fair-leadership)
*   [Level 1 FAIR strategy](#level-1-fair-strategy)
*   [Level 1 FAIR roles](#level-1-fair-roles)
*   [Level 1 FAIR processes](#level-1-fair-processes)
*   [Level 1 FAIR knowledge](#level-1-fair-knowledge)
*   [Level 1 FAIR tools and infrastructures](#level-1-fair-tools-and-infrastructures)

|     |     |     |     |     |
| --- | --- | --- | --- | --- |
| **Level** | **Nickname** | **Marketplace metaphor** | **Key Features** | **Picture** |
| 1   | "Started the FAIR journey." | "Flea market" | Awareness started, and the first pilots for implementation. | ![](images/level-1-fleamarket-circle.png)|

**Table level 1 summary.**
[FAIR Maturity Matrix: Dimensions (rows)](FMMdimensions.md)

<div class="video-wrapper">
<iframe src="https://player.vimeo.com/video/1155016797?h=3b19b7ea88&amp;app_id=122963" width="426" height="240" frameborder="0" allow="autoplay; fullscreen; picture-in-picture; clipboard-write; encrypted-media; web-share" referrerpolicy="strict-origin-when-cross-origin"></iframe> 
</div>
...
Organization members are sent to external workshops or training (e.g. [GO FAIR Foundation](https://www.gofair.foundation/training)) to lead the first internal projects.
...
*   [https://fairtoolkit.pistoiaalliance.org/use-cases/adoption-and-impact-of-an-identifier-policy-astrazeneca/](https://fairtoolkit.pistoiaalliance.org/use-cases/adoption-and-impact-of-an-identifier-policy-astrazeneca/)
    
*   [https://fairtoolkit.pistoiaalliance.org/methods/findability-maturity-indicators/](https://fairtoolkit.pistoiaalliance.org/methods/findability-maturity-indicators/)
...
*   [https://fairtoolkit.pistoiaalliance.org/methods/accessibility-maturity-indicators/](https://fairtoolkit.pistoiaalliance.org/methods/accessibility-maturity-indicators/)
...
*   [https://fairtoolkit.pistoiaalliance.org/methods/interoperability-maturity-indicators/](https://fairtoolkit.pistoiaalliance.org/methods/interoperability-maturity-indicators/)
