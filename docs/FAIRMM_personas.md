...
- [Purpose, who are FAIR personas for?](#purpose-who-are-fair-personas-for)
- [Context](#context)
- [Process](#process)
...
1. **Label of the {persona}:** e.g. Business_Leader  
   - this is the {persona} label, or identifier, which is used in FAIRMM and other frameworks

2. **Synonyms of {persona}**  
   - the same persona can be identified differently in various organizations

3. **Description of role of {persona}**  
   - Description of the role, or "job description" of the persona

4. **FAIR persona related to {persona}**  
...
6. **Issue for {persona}**  
   - description of issues experienced by the persona in a low level FAIR maturity organisaiton L0 - L1, or VPC "customer pains".

7. **Latent gains for {persona}**  
   - Description of what could the persona gain in a higher level FAIR maturity organisation (e.g. L2 - L4), or VPC "customer gains".

8. **Description of FAIR-benefits for {persona}**  
...
- **RDM kit:** <https://rdmkit.elixir-europe.org/your_role>  
  The RTM kit identifies six "roles": Data Steward, Policy Maker, Principal Investigator, Research Software Engineer, Researcher and Trainer. It provides extensive guidance not just on their profile identification but on how they can play a role in a FAIR organisation.

- **GO-FAIR:** <https://www.gofair.us/data-stewardship>  
...
- **Value Proposition Canvas (VPC):** <https://www.strategyzer.com/library/the-value-proposition-canvas>  
  The VPC was an inspiration for the template creation of the FAIR personas.
...
| --- | --- | --- | --- |
| Debashree | Chakrabarti | ABBVIE | 0 |
| Ranu | ⁠Sharma | ABBVIE | https://orcid.org/0009-0004-6207-0773 |
| Kathleen | Rand | AMGEN | 0 |
| Philippe | Rocca-Serra | Astrazeneca | 0 |
| Baptiste | Tauzin | CSL-Behring | 0 |
| Lynch | Nick | Curlew Research | https://orcid.org/0000-0002-8997-5298 |
| Avinash | Dixit | Datavid | https://orcid.org/0009-0005-8204-6655 |
| Ted | Slater | EPAM | https://orcid.org/0000-0003-1386-0731 |
| David | Fernandez Rue | Gruenenthal | https://0009-0007-6684-2605 |
| Nalini | Mehta | GSK | https://orcid.org/0000-0002-7553-6569 |
| Emiliano | Reynares | IQVIA | 0 |
| Katharina | Lang | Novo Nordisk | 0 |
| Karien | Pype | Ontoforce | 0 |
| Chris | Day | Perdl | 0 |
| Birgit | Meldal | Pfizer | https://orcid.org/0000-0003-4062-6158 |
| Giovanni | Nisato | Pistoia Alliance | https://orcid.org/0000-0002-5824-0061 |
| Rob | Gill | Pistoia Alliance | 0 |
| Tara Kumar | Gajula | Takeda | https://orcid.org/0009-0006-0072-7148 |
| John | Apathy | Xponentl | 0 |
| Aref | Rafat | Zifo | 0 |
| Maryline | Labasque | Zifo | 0 |
| 0 | 0 | 0 | 0 |
