[Home](index.md) | Back to [Level 1 “Started the FAIR journey”](level1.md) | Forward to [Level 3 “Pretty FAIR”](level3.md)
<hr>

# Level 2 "Getting FAIR"

*   [Level 2 Capabilities](#level-2-capabilities)
*   [Level 2 Business value](#level-2-business-value)
*   [Level 2 Questions to ask](#level-2-questions-to-ask)
*   [Level 2 FAIR data](#level-2-fair-data)
*   [Level 2 FAIR leadership](#level-2-fair-leadership)
*   [Level 2 FAIR strategy](#level-2-fair-strategy)
*   [Level 2 FAIR roles](#level-2-fair-roles)
*   [Level 2 FAIR processes](#level-2-fair-processes)
*   [Level 2 FAIR knowledge](#level-2-fair-knowledge)
*   [Level 2 FAIR tools and infrastructures](#level-2-fair-tools-and-infrastructures)

|     |     |     |     |     |
| --- | --- | --- | --- | --- |
| **Level** | **Nickname** | **Marketplace metaphor** | **Features** | **Picture** |
| 2   | "Getting FAIR" | "Street Market" | Pilots for FAIR implementation are in place | ![](images/level-2-street-market-circle.png) |
...
Requires average level technical and subject matter knowledge to use. ( cf. the role of [data scientist](https://pistoiaalliance.atlassian.net/wiki/spaces/PUB/pages/3366879360/FAIR+Maturity+Matrix+resources+and+lexicon#Data-scientist)).
...
*   [dentifier services](https://peta-pico.github.io/tapas/tapas.html?api=peta-pico/dsw-nanopub-api&op=/find_gofair_qualified_things_x&param_searchterm=%20&param_type=https://w3id.org/fair/fip/terms/Identifier-service&autosubmit=on)
